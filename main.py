...
class LinearAlgebraSolver:
    ...
    def load_from_json(self, filename):
        ...
        try:
            ...
            has_symbols = any(
                isinstance(element, str) for row in matrix_data for element in row
            )
        ...
        for col in range(min(m, n - (1 if b is not None else 0))):
            ...
            if max_row != pivot_row:
                ...
                if show_steps:
                    ...
                    self.print_matrix(augmented, "After row swap")
    ...
    def back_substitution(self, rref, show_steps=True):
        ...
        for i in range(m - 1, -1, -1):
            ...
            if leading_col != -1:
                ...
                if show_steps:
                    print(
                        f"x_{leading_col+1} = {Fraction(solution[leading_col]).limit_denominator()}"
                    )
    ...
    def solve_from_file(self, filename):
        ...
        if problem_type == "homogeneous":
            ...
            print(
                f"🤔 Unknown problem type '{problem_type}'. Defaulting to system solver."
            )
            return self.solve_system(A, b)
    ...
    def create_sample_files(self):
        ...
        print("   📄 example_1_3_6.json")
        print("   📄 sample_system.json")
        print("   📄 parametric_system.json")
